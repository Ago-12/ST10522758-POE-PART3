...
public class Part3POE {
     ...
     public static ArrayList<String> storedRecipient = new ArrayList<>();
    ...
    public void messageReport(){
     Scanner input = new Scanner(System.in);
        ...
        System.out.println("c ) Search for message ID and display the corresponding recipient and message");
    ...
    public static void displayRecipient(){
        for (int i = 0; i < storedMessage.size(); i++ ){
            ...
            System.out.println(
            "Sender: " + storedSender.get(i) +   "| Recipient: " + storedRecipient.get(i)
            );
        }
    }  
    ...
    public static void MessageIDsearch(){
        ...
        for( int i = 0; i < MessageID.size(); i++){
            if(MessageID.get(i).equals(ID)){
             System.out.println("Recipient: " + storedRecipient.get(i));
    ...
    public static void searchRecipient(){
        ...
        for (int i = 0; i < storedRecipient.size(); i++){
            if (storedRecipient.get(i).equalsIgnoreCase(recipient)){
